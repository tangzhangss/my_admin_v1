...
-- 正在导出表  ob_admin.tbl_banner 的数据：~1 rows (大约)
...
-- 正在导出表  ob_admin.tbl_wxapp_merchant 的数据：~2 rows (大约)
...
-- 导出  表 ob_admin.tbl_z_v_member 结构
CREATE TABLE IF NOT EXISTS `tbl_z_v_member` (
  ...
  `nickname` varchar(255) DEFAULT NULL COMMENT '微信名 base64编码之后的',
...
-- 正在导出表  ob_admin.tbl_z_v_member 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `tbl_z_v_member` DISABLE KEYS */;
REPLACE INTO `tbl_z_v_member` (`id`, `openid`, `wxopenid`, `sex`, `avatars`, `nickname`, `province`, `city`, `identity`, `create_time`, `realname`, `realavatars`, `contact`, `birthday`) VALUES
	(10000, 'wxb8155eccd3eaeda4', 'wxb8155eccd3eaeda4', 1, 'https://ps.ssl.qhimg.com/t0130a8defbfa9ea1c3.jpg', 'JXU1NTEwJXU0RTAw', '四川', '成都', 1, '2019-01-30 15:39:41', '唐一', 'https://ps.ssl.qhimg.com/t01fbc64cc5ebe202e8.jpg', '15520449931', '1996-12-27'),
	(10001, 'axb8155eccd3eaeda4', 'axb8155eccd3eaeda4', 1, 'https://ps.ssl.qhimg.com/t01b0262b5951df4f15.jpg', 'JXU1NTEwJXU0RThD', '四川', '成都', 1, '2019-01-30 15:42:27', '唐二', 'https://ps.ssl.qhimg.com/t01b780678b95aa668a.jpg', '15892453157', '1998-11-27'),
	(10002, 'test1', 'test1', 1, 'https://ps.ssl.qhimg.com/t01c0fcfd495374681c.jpg', 'JXU1NTEwJXU0RTA5', '四川', '成都', 1, '2019-01-30 15:44:48', '唐三', 'https://ps.ssl.qhimg.com/t01e8de37412884ac07.jpg', '12236987987', '1992-01-23'),
	(10003, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:45:52', '唐四', NULL, NULL, NULL),
	(10004, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:45:59', '唐五', NULL, NULL, NULL),
	(10005, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:46:07', '唐六', NULL, NULL, NULL),
	(10006, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:46:15', '唐七', NULL, NULL, NULL),
	(10007, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:46:28', '唐八', NULL, NULL, NULL),
	(10008, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:46:38', '唐九', NULL, NULL, NULL),
	(10009, NULL, NULL, 1, NULL, NULL, NULL, NULL, 1, '2019-01-30 15:46:53', '唐十', NULL, NULL, NULL);
/*!40000 ALTER TABLE `tbl_z_v_member` ENABLE KEYS */;
...
-- 正在导出表  ob_admin.tbl_z_v_member_doctor 的数据：~0 rows (大约)
