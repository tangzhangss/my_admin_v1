...
-- 正在导出表  ob_admin.tbl_menu 的数据：~2 rows (大约)
...
-- 正在导出表  ob_admin.tbl_menu_second 的数据：~6 rows (大约)
...
-- 正在导出表  ob_admin.tbl_object 的数据：~5 rows (大约)
...
INSERT INTO `tbl_object` (`id`, `owner`, `name`, `logo`, `descr`, `create_time`, `hold_date`, `hold_cost`, `hold_ins`, `user_id`, `status`) VALUES
	(1, '创荣科技', '全V健康', 'http://ob-admin.oss-cn-beijing.aliyuncs.com/picture/15520449931/1545282462028_64.jpg?x-oss-process=style/ob-picture-style', '创荣科技项目....', '2018-12-20 10:06:36', '2019-04-20 16:00:43', 0, '全职维护', 0, 1),
...
INSERT INTO `tbl_user` (`id`, `username`, `password`, `level`) VALUES
	(10, '15520449931', 'f3c4cc9c1d0903b690f668f9e401ab34', 1),
	(12, '17781694763', '4280d89a5a03f812751f504cc10ee8a5', 2);
